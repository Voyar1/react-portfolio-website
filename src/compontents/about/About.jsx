          ...
          <div className="about__content">
            <div className="about__cards">
              <article className="about__card">
                ...
                <h5>Commercial experience in SEO</h5>
                <small>1+ year working with SEO</small>
              </article>
              <article className="about__card">
                <FaAward className="about__icon" />
                <h5>Workflow</h5>
                <small>Experience in project management</small>
              </article>
              <article className="about__card">
                <FaAward className="about__icon" />
            ...
            <p>
              ...
              IT and E-commerce aspects, my greatest passion is sports - I
              believe that for a fully fit mind we also need a fit and healthy
              body 🏋️
            </p>
